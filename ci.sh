...
git config --global user.email "apurbo.ipe@gmail.com"
git config --global user.name "Apurboipe"
...
# 2018.May26
git commit -m  "Dashboard Release version 1.5.0.June-21-2018"
...
git remote set-url origin https://github.com/Apurboipe/generic-dashboard
############
# Step: 07 #
############
...
git push --all -f https://github.com/Apurboipe/generic-dashboard